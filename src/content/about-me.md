...
## Stuff I've Made:
- Fluxbuilder: A character builder webapp for the Flux Fantasy TTRPG (v3 with support for multiple characters in progress!).
- Astral: A Minecraft mod about building a base in your head, and astral projecting to collect resources for it!
- VG Ridelines: A website that documents decks and prices for Cardfight Vanguard. 
- TwoDee: A Discord bot to automate the Facets TTRPG system.

---

## What I am working on:
- Astral Wave, a worldbuilding project set in a fictional post-scarcity 27th century civilization. It is centered around exploring morphological freedom through customizable avatars dubbed "Projections" and full-dive wargames as a means to train people on a variety of hard and soft skills to defend against extradimensional invaders.
- Porting this website to Astro!
- Adding more decks to VG Ridelines!
- Leveling up my programming and TTRPG gamemastering skills!