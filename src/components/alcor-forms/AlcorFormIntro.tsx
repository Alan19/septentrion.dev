...
export function AlcorFormIntro() {
    return <Fade in>
        <Grid container direction={"column"} spacing={1}>
            ...
            <Grid item>
                ...
                <Typography variant={"body1"}>
                    The vessels are inspired by alternate universes where Alcor is of a different species. Since they're not sentient, Alcor can upload his mind into those bodies. Resting in the exotic matter-infused body tank in this room
                    seems to synchronize his memories with his other selves, and occasionally causes lucid dreams where he can interact with some of his alternate forms in a shared mental space. The bio-enhancement lab also contains a small
