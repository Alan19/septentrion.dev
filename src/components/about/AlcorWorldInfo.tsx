        ...
        <div>
            ...
            <Grid container direction={"row"} spacing={2}>
                ...
                <AboutPageParagraph title={"Alcor's Life"}
                                    ...
                                    img={<SkeletonImage src={superheroArtwork} aspectRatio={3782 / 3981}/>}
                ...
                <AboutPageParagraph title={"Castor - Symbiotic Companion"}
                                    ...
                                    img={<SkeletonImage src={castor} aspectRatio={1615 / 2240}/>}
                ...
                <AboutPageParagraph title={"Castor β - Sentinel Mode"}
                                    ...
                                    img={<SkeletonImage src={castorEvolution} aspectRatio={1430 / 2272}/>}
                                    variant={"h6"}
                />
            </Grid>
        </div>
