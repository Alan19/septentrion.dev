...
export function GallerySearchbar() {
    return (
        <Autocomplete.Root items={tags}>
            <Autocomplete.Input placeholder="e.g. feature" className={"field large prefix round fill active"}/>
            <Autocomplete.Icon><i className="front">search</i></Autocomplete.Icon>
            {/*<Autocomplete.Portal>*/}
